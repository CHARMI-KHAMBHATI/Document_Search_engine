...
<html>
  ...
  <div class="container-fluid">
   ...
   <div class="container">
	...
	<form role="form" class="form-horizontal" name="reg" id="file-form" action="register.php" method="post" onsubmit="return validateForm();" style="padding:50px;">
	...
	<div class="form-group">
	  ...
	  <br>
	  <label for="title" class="control-label col-md-5">Register to perform CRUD operations:</label>
	   ...
	   <div class="form-group">
		...
		<input type="text" name="username" id="username" class="form-control " required>
		 ...
		 <div class="form-group">
		<label for="title" class="control-label col-md-3">E-mail address</label>
		<div class="col-md-6">
